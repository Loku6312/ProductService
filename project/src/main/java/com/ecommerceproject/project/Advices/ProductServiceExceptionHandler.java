package com.ecommerceproject.project.Advices;
...
public class ProductServiceExceptionHandler {
    ...
    public ResponseEntity<Void> handleRuntimeExecption(){
    ...
    public ResponseEntity<String> handleProductNotFoundException(ProductNotFoundException productNotFoundException){
        return new ResponseEntity<>(productNotFoundException.getProductId()+" is an invalid product id, Please pass a valid product id",HttpStatus.NOT_FOUND);
    }
